...
class PeliculaDetalle extends StatelessWidget {
 ...
 Widget _actores(BuildContext context,Pelicula pelicula) {
   ...
   return FutureBuilder(
     ...
     builder: (BuildContext context, AsyncSnapshot<List> snapshot) {
       if(snapshot.hasData){
         return _crearAcotesPageView(context,snapshot.data);
       }
       else{
         return Center(
  ...
  Widget _crearAcotesPageView(BuildContext context,List<Actor> actores) {
